...
using UnityEngine;
using System;
public class object_manager_var6 : MonoBehaviour {
	public GameObject this_window;
	public GameObject next_window1;
	public GameObject next_window2;
	public GameObject next_window3;
	public GameObject next_window4;
	public GameObject next_window2f;
	...
	public IEnumerator Activate_event ()
	{
		...
		next_window3.SetActive (true);
		next_window4.SetActive (true);
		next_window2f.SetActive (false);
